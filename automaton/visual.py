...
class GUI:
    ...
    def add_cell(self, x, y, cell, size=None):
        ...
        if cell.cell_type == "wall":
            if (
                ...
                and y * self.coeff <= GUI.DISPLAY_Y
            ):
    ...
    def draw_button(self):
        ...
        if (
            self.play_button.is_on
            and self.play_button.draw(GUI.SCREEN)
            or self.end_generation
        ):
    ...
    def draw_text(self, generation):
        ...
        GUI.SCREEN.blit(
            self.font.render(
                f"Generation {generation - self.generations}", False, (10, 20, 10)
            ),
            (10, 10),
        )
