...
class GUI:
    ...
    def __init__(self):
        ...
        self.blue_bg  = Background("images/blue_bg.png", [0,0])
        self.green_bg = Background("images/green_bg.png", [0,0])
        # load button images
    ...
    def main(self):
        ...
        while self.run:
            ...
            # GUI.SCREEN.blit(self.blue_bg.image, self.blue_bg.rect)
            GUI.SCREEN.blit(self.green_bg.image, self.green_bg.rect)
